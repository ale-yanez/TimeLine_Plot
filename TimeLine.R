...
LAmNorte <- ggplot(NULL) + 
  ...
  annotate("rect", xmin=2012, xmax=2012.5, ymin=12, ymax=13, alpha=.8, fill="dodgerblue2") + # cpue bloq 3
...
#  annotate("segment", x=1997, xend=1997, y=10, yend=11, colour="green4") +            # crucero bloq 1
  annotate("rect", xmin=1997, xmax=1997.5, ymin=10, ymax=11, alpha=.8, fill="green4") + # crucero bloq 1
  ...
  annotate("rect", xmin=1985, xmax=1993, ymin=8, ymax=9, alpha=.8, fill="darkorchid4") + # prop hembras
